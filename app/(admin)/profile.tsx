...
export default function AdminProfile() {
  ...
  return (
    <View style={styles.container}>
      <ScreenHeader title="Profile" subtitle="System administrator account" />
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.infoCard}>
          ...
          <InfoRow icon="shield-checkmark" label="Role" value="System Administrator" />
        </View>
...
const styles = StyleSheet.create({
  ...
  avatar: { width: 80, height: 80, borderRadius: 40, backgroundColor: COLORS.danger, alignItems: "center", justifyContent: "center", marginBottom: SPACING.md },
  ...
  roleBadge: { flexDirection: "row", alignItems: "center", gap: 4, backgroundColor: "#FBE3E3", paddingHorizontal: SPACING.sm, paddingVertical: 4, borderRadius: 999, marginTop: SPACING.xs },
  roleText: { color: COLORS.danger, fontWeight: "700", fontSize: FONT.size.xs },
